...
[assembly: ExportRenderer(typeof(com.cstc.ShareJewlryApp.Mycontrols.BlurredImage), typeof(com.cstc.ShareJewlryApp.Droid.Renderer.BlurredImageRenderer))]
namespace com.cstc.ShareJewlryApp.Droid.Renderer
{
    public class BlurredImageRenderer : ViewRenderer<BlurredImage, ImageView>
    {
        ...
        public BlurredImageRenderer(Context c):base(c)
        {
            AutoPackage = false;
        }
